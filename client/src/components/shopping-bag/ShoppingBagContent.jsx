...
export default function ShoppingBagContent({
    _id,
    ticketImgUrl,
    ticketName,
    description,
    ...
    return (
        <li className="relative bg-gradient-to-b from-purple-700 to-black rounded-lg shadow-md overflow-hidden border-4 border-gray-400 transition-transform transform hover:scale-105">
