            ...
            <div className="flex flex-col md:flex-row justify-center items-start">
                <div className="sidebar w-full md:w-1/3 p-4">
                    <div className="bg-gray-800 rounded-lg p-4">
                        ...
                        <ul>
                            <li className="mb-2">
                                <a href="#account-settings" className="text-yellow-400">
                                    Account Settings
                                </a>
                            </li>
                            <li className="mb-2">
                    ...
                    >
                        ...
                        <div>
                            ...
                            <p className="text-green-400 mb-4">
                                Good news! Your confirmation email was sent, please press
                                confirm button from email.
                            </p>
