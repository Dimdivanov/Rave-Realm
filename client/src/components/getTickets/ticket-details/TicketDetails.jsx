    ...
    return (
        <>
            <div className="min-h-screen bg-gradient-to-b from-purple-700 to-black flex items-center justify-center py-10">
                <div className="w-full max-w-4xl p-6 bg-gray-900 bg-opacity-80 rounded-lg shadow-md backdrop-blur-md flex flex-col lg:flex-row">
                    ...
                    <div className="w-full lg:w-1/2">
                        <img
                            ...
                            alt="Ticket Image"
                            className="rounded-lg w-full h-auto object-cover lg:max-h-96"
                        />
                    </div>
